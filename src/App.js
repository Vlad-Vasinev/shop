...
import Breeds from "./components/breedsPage/BreedsPage";
import Gallery from "./components/galleryPage/GalleryPage";
import Voting from "./components/votingPage/VotingPage";
...
export const App = () => {
  ...
  const backgroundColorApp = useSelector(state => state.theme.themeBackgroundColor);
